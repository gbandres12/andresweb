...
// Parser local de CSV / XLSX robusto
...
// Normalizador inteligente de chaves de produtos
...
// Normalizador inteligente de movimentações de caixa / financeiro
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Se nenhum arquivo enviado, gera massa de teste inteligente!
    if (rows.length === 0) {
      if (mode === 'products') {
        rows = [
